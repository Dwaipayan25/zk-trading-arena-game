 ...
 */
type CircuitInfoResponse$1 = BoojumCircuitInfoResponse | CircomCircuitInfoResponse | Halo2CircuitInfoResponse | GnarkCircuitInfoResponse | JoltCircuitInfoResponse | NoirCircuitInfoResponse | Plonky2CircuitInfoResponse;
 ...
 * CircuitType choices
 */
type CircuitType = "boojum" | "circom" | "gnark" | "halo2" | "jolt" | "noir" | "plonky2";
...
declare class InternalService {
     ...
     * @throws ApiError
     */
    teamDetail(teamName: string): CancelablePromise<TeamDetail>;
    /**
     * Team Me
...
type CircuitInfoResponse = BoojumCircuitInfoResponse | CircomCircuitInfoResponse | Halo2CircuitInfoResponse | JoltCircuitInfoResponse | GnarkCircuitInfoResponse | NoirCircuitInfoResponse | Plonky2CircuitInfoResponse;
...
export { type AuthOptions, type BoojumCircuitInfoResponse, type CircomCircuitInfoResponse, type CircuitInfoResponse, type CircuitType, type GnarkCircuitInfoResponse, type Halo2CircuitInfoResponse, type JobStatus, type JoltCircuitInfoResponse, type LogLevel, type Meta, type NoirCircuitInfoResponse, type Plonky2CircuitInfoResponse, type ProofInfoResponse, SindriClient, _default as default };
